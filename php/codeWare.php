...
<?php
	...
	$helps = 0;
	if (stringIsSaved()) {
		echo "<p hidden id='password'>".$_SESSION['session_password-'.$_SESSION['difficulty']]."</p>";
		$_SESSION["string_saved-".$_SESSION["difficulty"]] = true;
	} else {
		...
		$pwd = $words[rand(0, sizeof($words)-1)];
		echo "<p hidden id='password'>".$pwd."</p>";
		$_SESSION['session_password-'.$_SESSION["difficulty"]] = $pwd;
	}
	...
	function stringIsSaved() {
		$cond1 = isset($_SESSION['session_password-'.$_SESSION["difficulty"]]) && $_SESSION['session_password-'.$_SESSION["difficulty"]] != "";
		$cond2 = isset($_SESSION['column1-'.$_SESSION["difficulty"]]) && $_SESSION['column1-'.$_SESSION["difficulty"]] != "";
		$cond3 = isset($_SESSION['column2-'.$_SESSION['difficulty']]) && $_SESSION['column2-'.$_SESSION['difficulty']] != "";
